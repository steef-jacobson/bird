...
class WatchesControllerTest < ActionController::TestCase
  ...
  test "should create watch" do
    assert_difference('Watch.count') do
      post :create, watch: { bird: @watch.bird, boro: @watch.boro, location: @watch.location, notes: @watch.notes, user_id: @watch.user_id }
    end
  ...
  test "should update watch" do
    put :update, id: @watch, watch: { bird: @watch.bird, boro: @watch.boro, location: @watch.location, notes: @watch.notes, user_id: @watch.user_id }
    assert_redirected_to watch_path(assigns(:watch))
  end
